...
ent-MobSecDogLaika = Лайка
    .desc = Подобно её имени, лайка является развидностью неоднозначной породы, прямиком с улицы и готовой к схватке.
ent-MobArcticFoxSiobhan = Шёвана
    .desc = Лисица с ирландским именем, также знанная как Шова среди её знакомых. Пушистая, душистая, умилительная арктическая лиса.
