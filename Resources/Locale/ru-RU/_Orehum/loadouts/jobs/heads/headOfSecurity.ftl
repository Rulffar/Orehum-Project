...
loadout-description-LoadoutCommandHOSJumpsuitFormal = Наряд довольно необычный. Мне любопытно, к чему может стремиться обладатель такого стильного образа.
...
loadout-description-LoadoutCommandHOSJumpskirtFormal = Наряд довольно необычный. Мне любопытно, куда мог направиться его обладатель, чтобы оправдать такой стильный образ.
loadout-description-LoadoutCommandHOSOuterWinter = Теплое пальто для холодного космоса.
loadout-description-LoadoutCommandHOSOuterTrench = Тренч-пальто для ГСБ.
loadout-description-LoadoutCommandHOSHatBeret = Берет для ГСБ.
loadout-description-LoadoutCommandHOSHatHoshat = Шляпа для ГСБ, довольно симпатичная.
