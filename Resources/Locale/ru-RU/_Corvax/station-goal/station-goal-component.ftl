...
station-goal-fax-paper-header =[color=#b8972d]███[/color][color=#1d7a1d]░███░░░░██░░░░[/color][color=#b8972d]                          ★ ★ ★[/color][color=#1d7a1d]
    ...
    [bold]1. Проведение какого либо спортивного соревнование на станции, вы как Командование станции
    должны организовать соревнование, построить специальную площадку для него, и сделать за это достойную награду[/bold]
    [bold]2. Постройка зоопарка, а после проведение мероприятие с участием экипажа, нужно показать
    экипажу животных, рассказать про их особенности и проследить за организацией, как Капитан, вы должны
    проследить за организацией мероприятия[/bold].
    [bold]3. Проведение какого-либо творческого мероприятие, которое заставит экипаж
    ...
    вы как Капитан, должны проследить за корректным его выполнением[/bold].
    [bold]4. Вы имеете право проявить саму свою инициативу насчет цели, и предложить ее нам, отправив
    на ФАКС ваше предложение, это предложение вы можете написать здесь, и мы проверим его:
    *Ваше Предложение по цели*[/bold]
