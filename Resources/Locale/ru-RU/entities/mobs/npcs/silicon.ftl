...
ent-MobPlantbot = садовничек
    .desc = Следит за растениями. Поливает и убирает сорняки.
ent-MobDisablerBot = глушестрельничек
    .desc = Гроза нарушителей порядка.
ent-MobBatonBot = дубиничек
    .desc = Гроза нарушителей порядка.
