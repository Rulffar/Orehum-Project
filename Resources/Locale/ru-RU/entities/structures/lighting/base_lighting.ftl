...
ent-AlwaysPoweredlightGreen = { ent-AlwaysPoweredWallLight }
    ...
    .desc = { ent-AlwaysPoweredWallLight.desc }
ent-LightSmallEmpty = малый светильник
    .desc = Осветительный прибор. Потребляет ток и излучает свет, если оснащён лампочкой.
    .suffix = Пустой
ent-N14LightSmallEmpty = малый светильник
    .desc = Осветительный прибор. Потребляет ток и излучает свет, если оснащён лампочкой.
    .suffix = Пустой
ent-LightSmallAlwayson = малый светильник
    .desc = Всегда работающий светильник.
    .suffix = Всегда запитанный
ent-N14LightSmallAlwayson = малый светильник
    .desc = Всегда работающий светильник.
    .suffix = Всегда запитанный
