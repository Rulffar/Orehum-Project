...
ent-WeaponEnergyRevolverSecurity = Энергетический револьвер EG-4
    .desc = Высокоэффективный энергетический револьвер, способный стрелять как смертельными, так и выводящими из строя пулями. Серийный номер на цевье указывает на то, что этот пистолет принадлежит сотруднику службы безопасности NT.