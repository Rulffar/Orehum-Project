...
ent-WeaponRevolverPirate = пиратский револьвер
    ...
    .suffix = Револьвер
ent-WeaponRevolverArgenti = Аргентин
    .desc = Гражданский револьвер Аргентин типа 20. Изготовлен компанией Silver Industries. Несмотря на то, что конструкция с расширенным цилиндром довольно древняя, опытный стрелок знает, как с ним обращаться. В нем используются винтовочные патроны 20-го калибра.
ent-WeaponRevolverArgentiEmpty = Аргентин
    .desc = Гражданский револьвер Аргентин типа 20. Изготовлен компанией Silver Industries. Несмотря на то, что конструкция с расширенным цилиндром довольно древняя, опытный стрелок знает, как с ним обращаться. В нем используются винтовочные патроны 20-го калибра.
    .suffix = Пустой
ent-WeaponRevolverArgentiSecurity = Аргентин
    .desc = Револьвер Аргентин типа 20 военного образца. Изготовлен компанией Silver Industries. Несмотря на то, что конструкция с расширенным цилиндром довольно древняя, опытный стрелок знает, как с ним обращаться. В нем используются винтовочные патроны 20-го калибра. Серийный номер на цевье указывает на то, что этот пистолет принадлежит сотруднику службы безопасности NT.
    .suffix = Револьвер