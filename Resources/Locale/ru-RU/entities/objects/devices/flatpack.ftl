...
ent-TegCenterPartFlatpack = упаковка ядра ТЭГа
    .desc = Сжатые сборочные части, используемые в сооружении ядра термоэлектрического генератора.
ent-TegCirculatorPartFlatpack = упаковка проточника ТЭГа
    .desc = Сжатые сборочные части, используемые в сооружении циркулятора термоэлектрического генератора.
