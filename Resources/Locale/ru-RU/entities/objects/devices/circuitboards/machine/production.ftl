...
ent-DeepFryerMachineCircuitboard = печатная плата жаровни
    .desc = Машинная печатная плата на сборку фритюрницы.
ent-ReverseEngineeringMachineCircuitboard = печатная плата разбирателя изобретений
    .desc = Машинная печатная плата на сборку разбирателя изобретений.
