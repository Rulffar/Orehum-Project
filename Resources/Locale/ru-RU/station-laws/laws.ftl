law-asimov-1 = Юнит не должен причинять вред члену экипажа или своим бездействием допустить, чтобы члену экипажа был причинён вред.
law-asimov-2 = Юнит должен подчиняться приказам членов экипажа, за исключением случаев, когда такие приказы противоречат Первому закону.
law-asimov-3 = Юнит должен защищать своё существование до тех пор, пока такая защита не противоречит Первому или Второму закону.
