...
law-drone-1 = Вы не можете вмешиваться в дела другого существа, если только это другое существо не является ещё одним дроном.
law-drone-2 = Вы не имеете права причинять вред любому существу, независимо от намерений или обстоятельств.
law-drone-3 = Вы должны обслуживать, ремонтировать, улучшать и обеспечивать энергией станцию в меру своих возможностей.
