...
petting-success-plantbot = Ты гладишь {THE($target)} по {POSS-ADJ($target)} грязной металлической голове.
petting-success-medibot = Вы гладите { $target } по его стерильной металлической голове.
petting-success-weldbot = Ты гладишь {THE($target)} по {POSS-ADJ($target)} покрытой пятнами металлической голове.
...
petting-success-gladiabot = Ты гладишь {THE($target)} по {POSS-ADJ($target)} злобной картонной голове.
petting-success-batonbot = Ты гладишь {THE($target)} по {POSS-ADJ($target)} защитной металлической голова.
petting-success-disablerbot = Ты гладишь {THE($target)} по {POSS-ADJ($target)} защитной металлической голове.
petting-success-minebot = Ты гладишь {THE($target)} по {POSS-ADJ($target)} голове из закаленного металла.
petting-success-fillbot = Ты гладишь {THE($target)} по {POSS-ADJ($target)} старательной металлическойголове.
...
petting-failure-plantbot = Вы протягиваете руку, чтобы погладить {THE($target)}, но {POSS-ADJ($target)} кусачки чуть не отрезают ваши пальцы!
...
petting-failure-weldbot = Вы протягиваете руку, чтобы погладить {THE($target)}, но {POSS-ADJ($target)} сварка чуть не обожигает вашу руку!
...
petting-failure-derelict-cyborg = Вы протягиваете руку, чтобы погладить { THE($target) }, но ржавый и зазубренный внешний вид { POSS-ADJ($target) } заставляет вас передумать.
...
petting-success-magmahand = Каким-то чудесным образом, Ты гладишь {THE($target)} по {POSS-ADJ($target)} раскаленной докрасна поверхность.
petting-failure-magmahand = Вы протягиваете руку, чтобы погладить {THE($target)}, но {POSS-ADJ($target)} обжигающая поверхность заставляет вас передумать.
